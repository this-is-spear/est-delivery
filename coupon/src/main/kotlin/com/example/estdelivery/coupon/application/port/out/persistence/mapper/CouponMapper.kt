...
import com.example.estdelivery.coupon.application.port.out.persistence.entity.CouponStateAmountType
import com.example.estdelivery.coupon.application.port.out.persistence.entity.CouponStateAmountType.FIX
import com.example.estdelivery.coupon.application.port.out.persistence.entity.CouponStateAmountType.RATE
import com.example.estdelivery.coupon.application.port.out.persistence.entity.CouponStateType
import com.example.estdelivery.coupon.application.port.out.persistence.entity.CouponStateType.EVENT
import com.example.estdelivery.coupon.application.port.out.persistence.entity.CouponStateType.HANDOUT
import com.example.estdelivery.coupon.application.port.out.persistence.entity.CouponStateType.PUBLISHED
