...
class IssueRandomCouponServiceTest : FreeSpec({
    ...
    "이벤트로 고정 할인 쿠폰을 발급한다." {
        ...
        every { loadRandomCouponIssueEventStatePort.findEvent(1L) } returns 랜덤_쿠폰_뽑기_이벤트
        ...
        every { updateRandomCouponIssueEventStatePort.participate(any(), any()) } returns Unit
